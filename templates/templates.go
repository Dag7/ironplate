...
//
//go:embed all:base all:monorepo all:devcontainer all:k3d all:dockerfiles all:tilt all:k8s all:components all:iac all:cicd all:cli all:service all:package all:claude-md all:skills all:scripts all:workspace
